...
export default function Packages() {
  const packages = [
    { title: "Básico", price: "₡40,000", features: ["1 sesión de fotos", "15 fotos editadas", "Entrega digital", "1 foto impresa enmarcada"] },
    { title: "Premium", price: "₡80,000", features: ["2 sesiones de fotos", "40 fotos editadas", "Video promocional corto", "1 foto impresa enmarcada"] },
    { title: "Elite", price: "₡165,000", features: ["4 sesiones de fotos", "60 fotos editadas", "Video profesional completo", "Asesoría de branding", "3 fotos impresas enmarcadas"] },
  ];
